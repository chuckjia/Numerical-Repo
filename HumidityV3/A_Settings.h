...
// Averaging method
int aveSolnFreq = 0;  // The frequency of using the averaging method. 0 or negative values indicate no averaging

// Total number of progress messages
int numProgMsg = 20;  // Progress messages are more frequent than movie frame prints and L2 norm info, guaranteed in setTimeSteps
