...
%CALCCELLCENTERS Calculate the coordinates of the cell centers. For an illustration of the trapezoid cell, see
%   the documentation file.
%   INPUT:: meshGridX: 2D matrix of size Nx+1 by Np+1. Its (i,j) entry is the x-coordinate x_{i-1/2}
%           meshGridP: 2D matrix of size Nx+1 by Np+1. Its (i,j) entry is the p-coordinate p_{i-1/2, j-1/2} 
%   OUTPUT:: cellCentersX: 2D matrix of size Nx by Np. Its (i,j) entry is the x-coordinate x_{i}
%            cellCentersP: 2D matrix of size Nx by Np. Its (i,j) entry is the p-coordinate p_{i, j}
