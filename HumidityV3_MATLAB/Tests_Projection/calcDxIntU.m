...
%   INPUT:: 
%            intU_vec: A vector of size Nx. Its ith conponent is the value int_pA^pB u(x_i,p)dp
%   OUTPUT:: 
%            res_vec: A vector of size Nx. Its ith conponent is the value (d/dx)int_pA^pB u(x_i,p)dp
