...
x0 = 0;  xf = 75000;  pA = 250;  % Mountain geometry
Nx = 200;  Np = 200;  % Size of mesh used in the Finite Volume Method
...
Dp_mat = calcDp_cellCenter(x0, pA, Dx, Nx, Np);
...
%% Functions used in the projection method
...
Nx = size(meshGridX, 1) - 1;  Np = size(meshGridX, 2) - 1;
cellCentersX = zeros(Nx, Np);  cellCentersP = zeros(Nx, Np);
