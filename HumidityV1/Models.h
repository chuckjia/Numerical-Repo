...
double _h_pB_MDL0;  // Controls the height of mountain
double _c1_pB_MDL0;  // 1 / 6000
double _c1_pBxDer_MDL0;  // heightFactor * 2 / 6000

double _c1_qs_MDL0;  // 0.622 * 6.112
double _n_initU_MDL0, // n in (4.10)
_cp_initU_MDL0, _cx_initU_MDL0; // Coefficients for p and x in (4.10), respectively

// Set values to the coefficients defined in this section
void setFcnCoef_MDL0() {
	_h_pB_MDL0 = 250.;
	_c1_pB_MDL0 = 1 / 6000.;
	_c1_pBxDer_MDL0 = 2 * _h_pB_MDL0 * _c1_pB_MDL0;
	_c1_qs_MDL0 = 0.622 * 6.112;

	_n_initU_MDL0 = 1.;
	_cp_initU_MDL0 = M_PI * p0Inv_CONST;
	_cx_initU_MDL0 = 2 * _n_initU_MDL0 * M_PI / xf;
}
...
double pB_fcn_MDL0(double x) {
	return 1000. - _h_pB_MDL0 * exp(-pow((x - 37500.) * _c1_pB_MDL0, 2));
}

// Derivative of pB function
double pBxDer_fcn_MDL0(double x) {
	double tmp = (x - 37500.) * _c1_pB_MDL0;
	return _c1_pBxDer_MDL0 * tmp * exp(-tmp * tmp);
}
...
// Coefficients used in the model
double _xfCubed_MDL1, _xf6thPow_MDL1;
double _c1_pB_MDL1;  // 1 / 3000
double _c1_pBxDer_MDL1;
double _pBx0_MDL1;  // pB(x0)
double _c1_exT_MDL1, _c2_exT_MDL1, _c3_exT_MDL1, _c4_exT_MDL1;
double _c1_exU_MDL1, _c1_exUpDer_MDL1;
double _c1_exW_MDL1;

void setFcnCoef_MDL1() {
	// Function coefficients
	_xfCubed_MDL1 = pow(xf, 3);
...
double pB_fcn_MDL1(double x) {
	return 1000. - 200. * exp(-pow((x - 25000.) * _c1_pB_MDL1, 2));
}
...
double exact_T_helper_fcn_MDL1(double x, double p) {
	return _c1_exT_MDL1 * x * pow(x - xf, 2) * (
			p * (_c2_exT_MDL1 * pow(p - pB_fcn_MDL1(x), 2) - _c3_exT_MDL1)
			+ _c4_exT_MDL1
	);
}
...
double exact_u_fcn_helper_MDL1(double x, double p) {
	...
	return _c1_exU_MDL1 * pow(x * (x - xf), 3) *
