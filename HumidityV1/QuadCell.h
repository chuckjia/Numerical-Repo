...
double a1_quadCell;
double a2_quadCell[Nx + 1][Np + 1], a3_quadCell[Nx + 1][Np + 1],
a4_quadCell[Nx + 1][Np + 1];
...
double e12_diagMatInv_quadCell[Nx + 1][Np + 1],
e22_diagMatInv_quadCell[Nx + 1][Np + 1];
